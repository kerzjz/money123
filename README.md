...
| 🍕 **五角大楼披萨指数** | 通过框架，源站为 [Pentagon Pizza Index - Real-Time Military Tension Indicatorl | PizzINT](https://www.pizzint.watch/)  |
...
- 数据：  
  ...
  - 五角大楼披萨指数 - [www.pizzint.watch](https://www.pizzint.watch/)
